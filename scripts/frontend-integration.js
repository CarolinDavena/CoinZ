 ...
 * This file demonstrates how to integrate Coinz with a web frontend
 */

// For React/Vue/Angular applications
export class CoinzClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new CoinzClient(provider, contractAddress);
